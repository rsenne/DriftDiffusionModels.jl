@testset "MLE recovery (module API) — conditional" begin
    ...
    true_model = DriftDiffusionModel(B=1.8, v=0.9, a₀=0.35, σ=1.0)
    ...
    init_model = DriftDiffusionModel(B=0.8, v=0.2, a₀=0.6, σ=1.0)
    ...
    @test isfinite(init_model.B) && isfinite(init_model.v) && isfinite(init_model.a₀)
